      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-muted-foreground">
            Sign up to build your interactive workspace
          </p>
        </div>
          ...
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
                We have registered your account. If email confirmation is enabled, please verify your inbox. You can now proceed to log in.
              </p>
              <Link
                href="/login"
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Amine"
                    className="w-full px-4 py-2 bg-background border border-border/70 rounded-xl text-foreground text-sm placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full mt-3 py-2.5 px-4 bg-primary hover:bg-primary/95 active:scale-[0.98] disabled:active:scale-100 disabled:opacity-50 text-primary-foreground text-sm font-semibold rounded-xl flex items-center justify-center gap-1.5 shadow-md shadow-primary/10 transition-all cursor-pointer"
                >
                  {loading ? (
                    <>
